...
def post_process(loc_word_dict,text):
    '''
    ...
    exclude_list = ['trust', 'ham$', 'ow$', '[a-wz]y$', 'hz', 'echo$', 'ork(s?)$', 'burg', 'guideline', 'suite', 'process', '^tea$', 'ic$', 'coronal', 'gue$', 'ion$', 'tead$', 'able$', 'proxy$', 'gether', 'hy$',
                        'meter', 'success', 'watch', 'threshold', 'epoxy', 'determin', 'risk', 'intermediate', 'intern', 'incubate', 'debate', 'subset', '\wtype', 'scop(e|ic|ie)', 'cop(y|ies)$', 'perform', 'ion$', 'ics$', '^mode', '^state', '-of-', 'xy$']
